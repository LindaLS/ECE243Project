...
void deflate(char *in_stream){
	while(*in_stream){
		...
		else printf("%s", convert_table[ (*in_stream)- 'a']);
...
int main(){
	...
	// 				 "0101100000"
	// 				 "1"};
	char in_stream[] = "0011000100000100000100001010101000001001110000010000011";

	inflate(in_stream);
	deflate("hello world my name is linda with a capital l");
	return 0;	
}
